...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while now_place.is_hive is False:
            if random_bee(now_place.bees) is None:
                now_place = now_place.entrance
                self.place_range +=1
            else:
                if self.min_range <= self.place_range <= self.max_range:
...
class WallAnt(Ant):
    name = 'Wall'
    food_cost = 4
    is_implemented = True   # Change to True to 
...
class ScubaThrower(ThrowerAnt):
    ...
    food_cost = 6
    is_implemented = True
    is_waterproof = True  # Change to True to 
...
# END Problem 12
    ...
    def __init__(self, gamestate):
         ...
         if gamestate.queen_initialized == False:
            gamestate.queen_initialized = True
         else:
